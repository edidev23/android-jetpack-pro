...
object DataDummy {
    ...
    fun generateDummyMoviesResponse(): List<MovieDiscover> {

        val movies = ArrayList<MovieDiscover>()
    ...
    fun generateDummyTvResponse(): List<TvDiscover> {

        val tvItem = ArrayList<TvDiscover>()
